...
var slides = [
	{title: 'Работы для отдела Клиентского сервиса и сапорта ФС\nТикетная админка, админка массовых сбоев',
		works: [
			...
			'<div class="presentation_mb10">Тикетная админка</div>' +
			...
			{img: 'i/works/ticket-admin2.png', description: 
				'<div class="presentation_mb10">Админка массовых сбоев</div>' +
		...
		works: [
			...
			{img: 'i/works/autopay1.png', description: 'Попап автоплатежей'},
